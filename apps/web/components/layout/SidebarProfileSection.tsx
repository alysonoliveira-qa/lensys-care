  ...
  return (
    <>
      <button
        ...
        className={`group rounded-xl text-left transition-colors hover:bg-sidebar-accent/50 ${
      ...
      >
        <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-sidebar-accent text-slate-300">
        ...
        {!isCollapsed && (
          <>
            <div className="min-w-0 flex-1">
              ...
              <span className="mt-1 block truncate text-[10px] text-sidebar-foreground/70">{roleLabel}</span>
            </div>
            <PencilLine className="h-4 w-4 flex-shrink-0 text-sidebar-foreground/70 transition-colors group-hover:text-indigo-400" />
          </>
        )}
      </button>
