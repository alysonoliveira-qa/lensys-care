...
export default function SidebarPlanStatus({
  ...
  return (
    <div className="m-4 flex flex-col items-center gap-2 rounded-xl border-t border-sidebar-border bg-slate-950/40 px-4 py-3">
      <div className="flex w-full items-center justify-between">
        <span className="text-xs font-semibold text-sidebar-foreground/70">Seu Plano:</span>
        <Badge
