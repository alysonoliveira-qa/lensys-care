...
export default function PreviousExamReferencePanel({
  ...
  return (
    <div
      className={`mt-4 flex flex-col gap-3 rounded-2xl border px-4 py-3 text-xs sm:flex-row sm:items-center sm:justify-between ${
        isApplied
          ? 'border-slate-200 bg-slate-50/80 text-slate-500 dark:border-slate-800 dark:bg-slate-950/30 dark:text-slate-400'
